...
function Welcome() {
  return (
    <div className="hero">
      ...
      <a href="https://cnodobescu.ro/"><button>Descoperă mai multe despre colegiu</button></a>
      <br />
      <h2>Unde ne găsești?</h2>
      <br />
      <p> Instagram: <a href="https://www.instagram.com/cnodobescu/" id='social'>@cnodobescu</a></p>
      <p> Facebook: <a href="https://www.facebook.com/p/Colegiul-Na%C8%9Bional-Alexandru-Odobescu-Pite%C8%99ti-100087081195895/" id='social'>@cnodobescu</a></p>
      <br />
